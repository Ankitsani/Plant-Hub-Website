    ...
    <div class="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-6 items-start">
      ...
      <div class="space-y-6">
        ...
        <div class="border-8 border-green-700 rounded-3xl p-4 text-center">
          <h1 class="text-3xl sm:text-4xl font-bold text-green-800 animate-pulse">About Developers</h1>
        </div>
        ...
        <div class="border-2 border-green-700 rounded-3xl p-4 sm:p-6 flex flex-col sm:flex-row justify-between">
          ...
          <div>
            ...
            <ol class="list-decimal pl-5 space-y-1 text-green-800">
              <li class="text-lg sm:text-xl font-medium"><a href="#" class="hover:underline hover:text-white">Harsh</a></li>
              <li class="text-lg sm:text-xl font-medium"><a href="#" class="hover:underline hover:text-white">Ankit</a></li>
              <li class="text-lg sm:text-xl font-medium"><a href="#" class="hover:underline hover:text-white">Aditya</a></li>
              <li class="text-lg sm:text-xl font-medium"><a href="#" class="hover:underline hover:text-white">Areeb Ali</a></li>
            </ol>
          </div>
  
          <!-- Roles -->
          <div class="mt-6 sm:mt-0 sm:ml-6 space-y-1 text-green-800 p-4">
            <p class="text-lg sm:text-xl font-bold">1. PHP, SQL, RestAPI's.</p>
            <p class="text-lg sm:text-xl font-bold">2. Designing Using Bootstrap and CSS.</p>
            <p class="text-lg sm:text-xl font-bold">3. Logical implementation using JS.</p>
            <p class="text-lg sm:text-xl font-bold">4. Chatbot, Deployment and Testing</p>
          </div>
        </div>
      </div>
