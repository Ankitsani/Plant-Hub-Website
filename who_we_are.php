...
<!-- Navbar -->
<nav class="fixed top-0 left-0 w-full bg-gray-100 shadow-md z-50">
...
<section id="who-we-are" class="py-20 px-4 md:px-20">
    ...
    <div class="flex justify-center items-center mt-10">
        <button class="bg-green-600 w-64 h-auto p-4 m-4 text-white hover:bg-white hover:text-green-800 rounded-3xl mt-6 mb-6 text-2xl font-medium"><a href="index.php#services">Know More</a></button>
    </div>
</section>
